                    ...
                    <Box className="border rounded-s-md shadow-md p-5">
                        <form onSubmit={handleSubmit}>
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12} sm={6}>
                                    <TextField required id='zip' name='zip' label='Zip/Pincode' fullWidth autoComplete='shipping postal-code'></TextField>
                                </Grid>
                                <Grid item xs={12} sm={6}>
                                    <TextField required id='phoneNumber' name='phoneNumber' label='Phone Number' fullWidth autoComplete='given-name'></TextField>
                                </Grid>
                                <Grid item xs={12} sm={6}>
                                <Button sx={{ py:1.5,mt: 2, bgcolor: "RGB(145 85 253)" }} size='large' type='submit' variant='contained'>Deliver Here</Button>
                                </Grid>
                            </Grid>
                        </form>
                    </Box>
