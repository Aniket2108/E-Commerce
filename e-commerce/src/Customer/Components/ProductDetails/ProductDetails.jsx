  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className='grid gris-cols-1 lg:grid-cols-2 gap-x-8 gap-x-10 pt-10'>
        {/* Image gallery */}
        ...
        <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
              ...
              <p className='opacity-50 text-sm'>40000 Ratings</p>
            ...
            <form className="mt-10">
              ...
              <Button color="secondary" variant='contained' sx={{px:"2rem",py:"1rem"}}>Add To Cart</Button>
            </form>
          </div>
